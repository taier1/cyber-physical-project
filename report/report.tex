...
\begin{figure}[H]
    ...
    \caption{The homepage of our web-application}
    \label{fig:homepage}
  \end{figure}

Regarding the table on the right, the color of the row  will change when there is an update in the values for that specific bike. On the map, the dots display the historical values for PM.
